...
@Component({
  selector: 'app-edit-interior-details',
  templateUrl: './edit-interior-details.component.html',
  styleUrls: ['./edit-interior-details.component.scss'],
})
export class EditInteriorDetailsComponent implements OnInit {
  @Input() isAdmin = false;
